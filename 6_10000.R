...
write.csv(result_df, file=paste0("6_10000_summary/6_10000_" , array_index , ".csv"))
write.csv(result_summary, file=paste0("6_10000_eventsummary/6_10000_event_" , array_index , ".csv"))
