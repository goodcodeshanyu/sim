...
write.csv(result_df, file=paste0("6_580_summary/6_580_" , array_index , ".csv"))
write.csv(result_summary, file=paste0("6_580_eventsummary/6_580_event_" , array_index , ".csv"))
