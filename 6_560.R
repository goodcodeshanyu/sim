...
write.csv(result_df, file=paste0("6_560_summary/6_560_" , array_index , ".csv"))
write.csv(result_summary, file=paste0("6_560_eventsummary/6_560_event_" , array_index , ".csv"))
