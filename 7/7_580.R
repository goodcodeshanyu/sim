...
write.csv(result_df, file=paste0("7_580_summary/7_580_" , array_index , ".csv"))
write.csv(result_summary, file=paste0("7_580_eventsummary/7_580_event_" , array_index , ".csv"))
