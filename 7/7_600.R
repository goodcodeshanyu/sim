...
write.csv(result_df, file=paste0("7_600_summary/7_600_" , array_index , ".csv"))
write.csv(result_summary, file=paste0("7_600_eventsummary/7_600_event_" , array_index , ".csv"))
